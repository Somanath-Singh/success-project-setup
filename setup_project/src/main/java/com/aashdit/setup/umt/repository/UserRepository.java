...
public interface UserRepository extends JpaRepository<User, Long> , JpaSpecificationExecutor<User> {
    ...
    @Query(value = "select * from t_umt_user tuu \r\n"
    		+ "where tuu.email =:email", nativeQuery = true)
	User getDataByStaffEmail(String email);
    
    @Query(value="select tuu.user_id from t_umt_user tuu  where tuu.username ='admin'",nativeQuery= true)
