...
public class RoleLevelMap extends Auditable<Long> implements Serializable {
	...
	@Column(name = "max_allocations", columnDefinition = "bigint default -1")
	private Long maxAllocations = -1L;
