...
public class RandomNumberGenerate {
	...
	public static String generateGatePassId(String buyType, String vehicleNo) {
		...
		String trainingCode = buyType + "/" + generateFileNoSuffix + "/" + vehicleNo.replaceAll("\\s+", "") + "/"
				+ randomNumber;
	...
	public static String getRandomUniqueCodeNumbesOnly(int length) {
		SecureRandom random = new SecureRandom();
		StringBuilder sb = new StringBuilder(length);
	...
	public static String getJobRandomCOde() {
		SecureRandom random = new SecureRandom();
		String randomNumber = String.format("%06d", random.nextInt(10000));
		String jobCode = "JOB-" + randomNumber;
		return jobCode;
	}
