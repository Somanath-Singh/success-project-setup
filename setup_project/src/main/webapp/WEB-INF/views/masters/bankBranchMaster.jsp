    ...
    <form class="form-horizontal" action="${contextPath}/config/bankBranchMst" method="POST" id="userForm">
        ...
        <div class="row">
            <div class="form-group col-md-2">
                ...
                <div id="hideUserId">
                    <div class="col-md-12">
                        <select name="bankBranchMaster.bankId.bankId" id="bankId" class="form-control form-select selectpicker" required="required" value="${editBranchMaster.bankBranchMaster.bankId.bankName}" data-live-search="true">
        ...
        <div class="form-group col-md-12 text-center" style="margin-top: 7px;">
            <button type="button" class="btn btn-submit" onclick="validateForm('${empty editBranchMaster.bankBranchMaster.bankBranchId ? 'SAVE' : 'UPDATE'}')">
