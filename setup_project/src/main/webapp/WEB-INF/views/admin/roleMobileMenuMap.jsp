    ...
    <div class="col-md-12">
		...
		<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
			<div class="form-group col-md-3">
				...
				<div class="col-sm-12">
					<select class="form-control selectpicker" name="roleId" id="roleId" data-live-search="true">
		...
		<div class="form-group col-md-12 text-center">
			...
			<a href="${contextPath}/" class="btn btn-danger btn-sm">Cancel</a>
		</div>
	</div>
</div>
	</div>
...
<link href="${contextPath}/assets/js/jquery-fancytree/skin-xp/ui.fancytree.css" rel="stylesheet" />

<!-- Fancy Tree needs this version of jquery-ui -->
<script	src="${contextPath}/assets/js/jquery-fancytree/jquery-ui.min.js"></script>
<script	src="${contextPath}/assets/js/jquery-fancytree/jquery.fancytree-all.min.js"></script>
...
$().ready(function(){
	...
	$('#roleId').change(function(){
		...
		$.ajax({
			url : "${contextPath}/admin/mobile-menu/" + roleCode,
			type: "GET",
	        dataType: "json",
	...
	$('#btnAssign').click(function(){
		...
		$.ajax({
			url : "${contextPath}/admin/mobile-menu/assign",
			type: "POST",
			data : {
				"_csrf" : '${_csrf.token}',
				"data" : distIds,
