...
<div class="breadcrumb_conatiner">
	<div class="col-md-6">
		<h4 class="change-color">View User</h4>
	</div>
	<div class="col-md-6">
	...
	<form class="form-horizontal" action="#" method="POST" id="userForm">
		...
		<div class="col-md-12" style="padding-top: 15px;margin-bottom: 15px;">
				<table class="table table-bordered table-striped mb-none"  id="tableId1">
					...
					<c:forEach items="${userRoleHcMapList}" var="userRoleHcMapList" varStatus="index"> 
						<tr>
							...
							<td>
								<select class="form-select" name="isPrimary[]" id="isPrimary${index.count}" disabled="disabled">
									<option value=""><spring:message code="label.common.select"></spring:message></option>
							...
							<td>
								<select class="form-select" name="roleName[]" disabled="disabled" id="roleName${index.count}" data-plugin-selectTwo onchange="checkDuplicate(${index.count},this.value)">
									<option value=""><spring:message code="label.common.select"></spring:message></option>
							...
							<td>
								<select class="form-select" name="status[]" disabled="disabled" id="status${index.count}" >
			...
			<div class="form-group col-md-12 text-center">
				<a href="${contextPath}/umt/user/list" type="button" class="btn btn-sm btn-warning">Back</a>
			</div>
		</form>
	</div>
	</div>	
