...
<div class="breadcrumb_conatiner">
	<div class="col-md-6">
		<h4 class="change-color">Edit User</h4>
	</div>
	<div class="col-md-6">
...
<div class="row">
	...
	<form class="form-horizontal" action="${contextPath}/umt/user/update"
				...
				<div id="hideUserId">
					<div class="col-md-12">
						<input type="text" id="username" name="username"
							...
							onchange="userNameValidation();" maxlength="60">
					</div>
				</div>
			</div>
			<div class="form-group col-md-2">
			...
			<div class="form-group col-md-2">
				...
				<div class="col-md-12">
					<input type="text" name="userMobile" id="userMobile"
						...
						value="${userDetails.mobile}" onchange="validateMobileNo(this);"
						required>
				</div>
			</div>
			<div class="form-group col-md-2">
				...
				<div class="col-md-12">
					<input type="text" name="userEmail" id="userEmail"
						...
						value="${userDetails.email}" onchange="validateEmail(this);"
			...
			<div class="form-group col-md-2">
				...
				<div class="col-md-12">
					<input type="text" name="designation" id="designation"
						...
						value="${userDetails.designation}" required maxlength="150">
				</div>
			</div>
		</div>
			...
			<table class="table table-bordered table-striped mb-none"
				...
				<thead>
					<tr>
						...
						<!-- <th><label>Health CheckUp Center</label> -->
				...
				<tbody class="tableMargin">
					<c:forEach items="${userRoleHcMapList}" var="userRoleHcMapList"
						varStatus="index">
						<tr>
							<td>
								<p align="center">
							...
							<td><select class="form-control selectpicker" name="roleName[]"
								id="roleName${index.count}" data-plugin-selectTwo
								onchange="checkDuplicate(${index.count},this.value)" data-live-search="true">
									<option value=""><spring:message
											code="label.common.select"></spring:message></option>
		...
		<div class="form-group col-md-12 text-center">
			<button type="button" class="btn btn-success btn-sm" id="abcBtnId">Submit</button>
...
<script>
	...
	document.getElementById('abcBtnId').addEventListener('click', validateForm);
