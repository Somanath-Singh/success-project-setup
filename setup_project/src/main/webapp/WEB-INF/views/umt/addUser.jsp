...
<div class="breadcrumb_conatiner">
	<div class="col-md-6">
		<h4 class="change-color">Add User</h4>
	</div>
	<div class="col-md-6">
	...
	<div class="col-md-12">
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form class="form-horizontal" action="${contextPath}/umt/user/add"
					...
					<div class="row">
							...
							<div id="hideUserId">
								<div class="col-md-12">
									<input type="text" id="username" name="username"
										...
										onchange="userNameValidation();" maxlength="50">
								</div>
							</div>
						</div>
						<div class="form-group col-md-2">
						...
						<div class="form-group col-md-2">
							<label class="col-md-12 required" for="mobile">Mobile No. :</label>
							<div class="col-md-12">
								<input type="text" name="userMobile" id="userMobile"
									class="form-control form-control-sm NumbersOnly" maxlength="10"
									onchange="validateMobileNo(this);" required>
							</div>
						</div>
						<%--  <div class="col-md-12">
		<div class="form-group col-md-2">
				...
				<input type="text" name="dateOfbirth" id="dateOfbirth" class="form-control form-control-sm" maxlength="10" value="<fmt:formatDate value="${userDetails.dateOfBirth}" pattern="dd-MM-yyyy" />" >
						...
						<div class="form-group col-md-2">
							...
							<div class="col-md-12">
								<input type="email" name="userEmail" id="userEmail"
									...
									onchange="validateEmail(this);" required maxlength="150">
							</div>
						</div>
						<div class="form-group col-md-2">
								...
								<table class="table table-bordered table-striped mb-none"
									...
									<thead>
										<tr>
											...
											<th><label>Primary Role</label></th>
										...
										<c:forEach items="${userRoleHcMapList}"
											...
											<tr>
												<td align="center"><input type="hidden"
													...
													value="${userRoleHcMapList.userRoleId}" /> ${index.count}
												</td>
												<td><select class="form-select" name="isPrimary[]"
													id="isPrimary${index.count}">
												...
												<td><select class="form-select" name="roleName[]"
													id="roleName${index.count}" data-plugin-selectTwo
												...
												<td style="text-align: center;">
													<button type="button" class="btn btn-danger btn-sm"
														...
														<i class='fa fa-minus' aria-hidden='true' style="margin-top:-20px;"
					...
					<div class="col-md-12 mt-2 text-center">
						<input type="button" class="btn btn-success btn-sm" value="Submit"
							onclick="return validateUserForm()"> <a
							href="${contextPath}/home" type="button"
...
function userNameValidation(){
	...
	function createRow(){
		...
		var cellVal1 = '<select name="roleName[]" id="roleName' +totalRows+ '" class="form-control form-select form-control-sm" onchange="checkDuplicate(' +totalRows+ ',this.value)" >';
		var cellVal2 = '<select name="isPrimary[]" id="isPrimary' +totalRows+ '" class="form-control form-select form-control-sm multi-formcontrol" >';
		...
		cell5.innerHTML = "<button type='button' class='btn btn-danger btn-sm' id='deleteMap"+totalRows+"' onclick='deleteRow(this);' title='Remove Current Row' style='margin-top:-20px;'><i class='fa fa-minus' aria-hidden='true'></i></button>";
