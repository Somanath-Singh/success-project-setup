...
public class SystemController {
	...
	public String createStructure(Model model, @RequestParam(required = false) String filterData, @RequestParam(required = false) String textOrgName){
		try {
			...
			if(filterData != null && !filterData.isEmpty()){
				...
				List<OrganizationStructureParentChild> hierarchyList = priviledgeService.viewOrganizationStructure(filterData);
			...
			umtConfigCoreFn.addEntityIdAndLevelToModelWithData(model, OrganizationStructure.class, true, selectedEntityId, false, true);
		}catch (Exception e){
	...
	public String createStructureNew(Model model, @RequestParam(required = false) String filterData, @RequestParam(required = false) String textOrgName){
		try {
			String selectedEntityId = "";
			if(filterData != null && !filterData.isEmpty()){
	...
	public ResponseEntity<?> getLevels(){
		try {
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(priviledgeService.getOrganizationLevelList()), HttpStatus.OK);
		}catch (Exception e){
	...
	public String saveStructure(@RequestParam("organizationStructureArr") String organizationStructureArr, RedirectAttributes attr){
		try {
	...
	@ResponseBody
	public ResponseEntity<?> getEntitySpecificEntity(@RequestParam("entityIdAndTypeEncode") String entityIdAndTypeEncode, @RequestParam("levelCode") String levelCode,
													 @RequestParam("orgId") String orgIdEncode,
													 @RequestParam("levelHeight") String levelHeight){
		try {
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(priviledgeService.getEntitySpecificEntity(entityIdAndTypeEncode, levelCode, orgIdEncode, levelHeight)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<?> saveEntitySpecificEntity(@RequestParam("mappingData") String mappingEncodedJsonData){
		try {
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(priviledgeService.saveEntitySpecificEntity(mappingEncodedJsonData)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<?> getEntitiesByCurrentUser(@RequestParam("entityId") String entityId, @RequestParam("classObjectValue") String classObjectValue, @RequestParam("currentClassObjectId") String currentClassObjectId){
		try {
			// decode
			Base64.Decoder decoder = Base64.getDecoder();
			...
			Long currentObjectId = currentClassObjectId != null && !currentClassObjectId.isEmpty() ? Long.parseLong(CommonHelperFunctions.decodeBase64(currentClassObjectId)) : 0L;
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(umtConfigCoreFn.getParentEntities(entityIdLong, entityLevel, classObjectValueDecode, currentObjectId)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	@ResponseBody
	public ResponseEntity<?> getChildListEntityHierarchyList(@RequestParam("entityId") String entityId, @RequestParam(value = "classObjectValue", required = false) String classObjectValue, @RequestParam(value = "currentClassObjectId", required = false) String currentClassObjectId){
		try {
			// decode
			Base64.Decoder decoder = Base64.getDecoder();
			String entityIdDecode = new String(decoder.decode(entityId));
			...
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(umtConfigCoreFn.getChildListEntityHierarchyList(entityIdLong, entityLevel, currentObjectId)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	public ResponseEntity<?> getCurrentEntityChildListEntityHierarchyList(){
		try {
			...
			return new ResponseEntity<>(CommonHelperFunctions.onSuccess(umtConfigCoreFn.getChildListEntityHierarchyList(entityIdLong, entityLevel, 0L)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
	...
	@ResponseBody
	public ResponseEntity<?> getPublicAndEntitySpecificRoleList(@RequestParam("entityIdAndType") String entityIdAndType, @RequestParam(value = "selectedEntityIdAndType", required = false) String selectedEntityIdAndType){
		try {
			Base64.Decoder decoder = Base64.getDecoder();
			...
			if(selectedEntityIdAndType != null && !selectedEntityIdAndType.isEmpty()){
				...
				List<Role> selectedRoleList = roleService.getEntitySpecificSelectedRoleList(selectedEntityId, selectedEntityLevel);
	...
	public ResponseEntity<?> getRoleListByEntityId(@RequestParam("entityId") String encodedEntityIds) {
	    try {
	        ...
	        for (String data : compaSpit) {
	            ...
	            List<RoleEntityCommonDto> rolesForEntity = umtConfigCoreFn.getRoleListByEntityId(entityIdLong, entityLevel);
	...
	public ResponseEntity<?> getHierarchyView(@RequestParam("entityIdAndType") String entityIdAndType){
		try {
			...
			Long entityId = Long.parseLong(split[0]);
			String entityLevel = split[1];
			return new ResponseEntity<>(CommonHelperFunctions.onGsonObjectSuccess(priviledgeService.getHierarchyView(entityId, entityLevel)), HttpStatus.OK);
		}catch (Exception e){
			return new ResponseEntity<>(CommonHelperFunctions.onError(e), HttpStatus.INTERNAL_SERVER_ERROR);
		}
	}
