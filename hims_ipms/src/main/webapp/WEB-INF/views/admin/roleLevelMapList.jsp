...
<div class="breadcrumb_conatiner">
	<div class="col-md-6">
		<h4 class="change-color">Role Access to Levels</h4>
	</div>
	<div class="col-md-6">
	...
	<div class="col-md-12">
		...
		<div class="card">
			<div class="card-header">
				...
				<h5 class="card-title">Role Access to Levels</h5>
			</div>
			<div class="card-body">
				...
				<form class="form-horizontal"
					...
					<div class="col-md-12"
						...
						<label style="font-size: 15px !important; margin-bottom: 10px;">
							<b>Role :-</b> <span
												...
												<td><c:set var="hasIt" value="false" /> <c:forEach
														...
														<c:if
															...
															<input type="checkbox" checked name="roleLevelId"
																id="roleLevelId" value="${roleLevel.roleRightLevelId}" />
															<c:set var="hasIt" value="true" />
														</c:if>
													</c:forEach> <c:if test="${hasIt eq false }">
														<input type="checkbox" name="roleLevelId" id="roleLevelId"
				...
				<h5 style="font-size: 16px; margin-top: 14px;">Max Allocations
					value of -1 means there is no limit to how many Entities can be
					assigned to this Role - level combination</h5>
			</div>
			]
		</div>
	</div>
