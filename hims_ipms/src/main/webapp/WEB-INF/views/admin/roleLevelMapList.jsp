...
<div class="row">
	...
	<form class="form-horizontal" action="${contextPath}/admin/role/roleLevelMap/addNupdate" method="POST" id="userForm">
		...
		<div class="card-footer text-center mt-2">
			...
			<a href="${contextPath}/admin/role/list" type="button" class="btn btn-warning">Back</a>
		</div>
	</form>
	<h5 style="font-size: 16px; margin-top: 14px;">Max Allocations value of -1 means there is no limit to how many Entities can be assigned to this Role - level combination</h5>
</div>
