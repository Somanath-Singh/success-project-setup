...
<c:set var="userDynamicEntityIdAndLvl"
	value="${principal.currentUserVo.currentUserEntityIdAndUserLevel}" />
<style>
.fa-unlock {
	color: #003a7a;
}
		...
		<div class="card">
			...
			<div class="card-body">
				...
				<form class="form-horizontal"
					action="${contextPath}/office/saveOfficeMaster" method="POST"
					id="officeForm">
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}" /> <input type="hidden" name="id"
						value="${officeDetails.id}" />
					<div class="row">
						...
						<div class="form-group col-md-3">
							...
							<div class="col-md-12">
								<input type="text" id="officeName" name="officeName"
									value="${officeDetails.officeName}" maxlength="30"
									class="form-control form-control-sm thisisRequiredField">
							</div>
						</div>
						<div class="form-group col-md-3">
							...
							<div class="col-md-12">
								<input type="text" name="officeAddress" id="officeAddress"
									class="form-control form-control-sm thisisRequiredField"
									maxlength="30" value="${officeDetails.officeAddress}">
							</div>
						</div>
						<div class="form-group col-md-3">
							<label class="">Office Phone. No :</label>
							<div class="col-md-12">
								<input type="text" name="officePhone" id="office"
									class="form-control nonFractionalNumber validPhoneNo form-control-sm"
									maxlength="15" value="${officeDetails.officePhone}" min="6">
							</div>
						</div>
						<div class="form-group col-md-3">
							<label class="required">Email :</label>
							<div class="col-md-12">
								<input type="text" name="officeEmail" id="officeEmail"
									class="form-control validEmail form-control-sm thisisRequiredField"
									maxlength="30" value="${officeDetails.officeEmail}">
							</div>
						</div>
					...
					<div class="form-group col-md-12 text-center mt-3">
						<input type="button" class="btn btn-success btn-sm" value="Save"
							...
							href="${contextPath}/office/officeMasterList"
				...
				<div class="col-md-12">
					...
					<div class="table-responsive">
						<table id="basic-datatables"
							class="datatable table table-striped table-bordered exportbtn mt-5">
							<thead>
								<tr>
									...
									<th>Address</th>
									<th>Phone No</th>
									<th style="width: 190px;"><spring:message
											code="site.common.action"></spring:message></th>
								</tr>
							</thead>
							<tbody id="tbd">
								<c:forEach items="${officeMasterList}" var="office"
									varStatus="officeCnt">
									<tr>
										...
										<td>
											<button class="btn btn-primary btn-sm"
												onclick="editApplicationById('${office.id}')"
												title="Edit Role">
												<i class="fa fa-edit"></i>
											</button>

											<button class="btn btn-success btn-sm"
												onclick="activateDeactivateRole('${office.id}')"
												title="${office.active ? 'Lock' : 'Unlock'} Office">
												<i
													class="${!office.active ? 'fa fa-lock text-white' : 'fa fa-unlock text-white'}"></i>
											</button>
...
<form action="${contextPath}/department/add" method="get"
	id="viewDepartmentForm">
