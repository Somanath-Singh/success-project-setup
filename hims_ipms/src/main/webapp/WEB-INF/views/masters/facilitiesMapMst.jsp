...
<script type="text/javascript"
	src="${contextPath}/assets/utilsJs/common-utils.js"></script>
		...
		<div class="card">
			...
			<div class="card-body">
				<form class="form-horizontal"
					action="${contextPath}/facility/saveFacilityDetails" method="POST"
					id="facilityMstForm" enctype="multipart/form-data">
					<input type="hidden" name="${_csrf.parameterName}"
						value="${_csrf.token}" /> <input type="hidden"
						name="facilitiesMapId" value="${facilityMstData.facilitiesMapId}"
						id="facilitiesMapId" />
					<div class="row">
						...
						<%@ include
							file="/WEB-INF/views/masters/entityAndUser/entityIdAndUserLevelList.jsp"%>
						...
						<div class="form-group col-md-2">
							...
							<div class="col-md-12">
								<input type="text" id="facilityName" name="facilityName"
									...
									class="form-control thisisRequiredField AlphaNumericOnly form-control-sm"
									required maxlength="100"
									value="${facilityMstData.facilityName}">
							</div>
						</div>
						<div class="form-group col-md-2">
							<label class="required">Has Parent</label>
							<div class="col-md-12 d-flex form-control"
								style="background: #e2e9ef;">
								<div class="form-check me-2">
									<input class="form-check-input" type="radio" name="hasParent"
										id="hasParentYes" value="YES"
										${facilityMstData.hasParent eq 'TRUE' ? 'checked' : ''}
										onclick="show1()"> <label class="form-check-label"
										for="hasParentYes"> Yes </label>
								</div>
								<div class="form-group">
									<input class="form-check-input" type="radio" name="hasParent"
										id="hasParentNo" value="NO"
										${facilityMstData.hasParent eq 'FALSE' || facilityMstData.hasParent == null ? 'checked' : ''}
										onclick="show1()"> <label class="form-check-label"
										for="hasParentNo"> No </label>
								</div>
							</div>
						</div>
						<div class="form-group col-md-2 d-none" id="doc1">
							...
							<div id="hideUserId">
								<div class="col-md-12">
									<input type="hidden" value="${facilityMstData.parentId}"
										id="parentIdHiddenId"> <select name="parentId"
										id="parentId" class="form-control form-select"
										required="required">
						...
						<div class="form-group col-md-4">
							...
							<div class="col-md-12">
								<textarea type="text" id="description" name="description"
									...
									title="${facilityMstData.description}">${facilityMstData.description}</textarea>
							</div>
						</div>
					</div>
					...
					<div class="col-md-12 mt-2 text-center">
						<button type="button" class="btn-submit btn"
							onclick="submitForm('${empty facilityMstData.facilitiesMapId ? 'SAVE' : 'UPDATE'}')">
							<spring:message
								code="${empty facilityMstData.facilitiesMapId ? 'site.common.submit' : 'site.common.update'}" />
						</button>
						<a href="javascript:void(0)" onclick="backFormSubmit()"
		...
		<div class="col-md-12">
			<div class="card full-height">
				...
				<div class="card-body">
					<div class="row">
						<%@ include
							file="/WEB-INF/views/masters/entityAndUser/entityIdAndUserLevelListDrp.jsp"%>
					</div>
					<div class="table-responsive">
						<table class="display table table-bordered table-hover exportbtn"
							style="width: 100%; table-layout: fixed;" id="tableId1">
							<thead>
								<tr>
							...
							<tbody>
								<c:forEach items="${facilityList}" var="facility"
									...
									<tr>
										...
										<td>
											<button type="button"
												onclick="editFacilityDtls(${facility.facilitiesMapId})"
												class="btn btn-info btn-sm" title="Edit"
												style="height: 22px; width: 26px; padding: 0 7px !important; line-height: 7px">
												<i class=" fa fa-edit " aria-hidden="true"></i>
											</button>
											<button type="button"
												onclick="mapFacilityAsset(${facility.facilitiesMapId})"
												class="btn btn-info btn-sm" title="Map"
												style="height: 22px; width: 26px; padding: 0 7px !important; line-height: 7px;">
...
<form action="${contextPath}/facility/editMappingDetails" method="get"
	id="editFacilityForm">
	<input type="hidden" name="mapId" id="facilityMapId">
</form>
<form action="${contextPath}/assetFacility/mapFacilityAsset"
	method="get" id="mapFacilityAssetForm">
	<input type="hidden" name="mappingId" id="facilityId"> <input
		type="hidden" name="parentEntityIdAndTypeIdName" value=""
		id="parentEntityIdAndTypeIdName">
</form>
<script>
