                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
						...
						<div class="row mt-3">
							...
							<div class="col-md-3">
								<label class="control-label">Is Common For All</label>
								<input type="Checkbox" id="isCommonForAllId">
							</div>
							<div class="col-md-2">
	...
	function saveStageConfigData(){
		...
		bootbox.confirm({
			...
			callback: function (result) {
				if(result){
					let isCommonForAll = $("#isCommonForAllId").prop("checked");
					if (isCommonForAll) {
						$("#saveAndUpdateStageConfigObject").append('<input type="hidden" name="commonWorkflowParamName" value="true">');
					}
