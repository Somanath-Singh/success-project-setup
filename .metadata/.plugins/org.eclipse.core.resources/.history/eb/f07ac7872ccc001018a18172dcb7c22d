...
<div class="content">
    ...
    <ul>
        <li><a href="${contextPath}/" style="color: #b4ff00; important!">Back to Home</a></li>
    </ul>
</div>
<script src="${contextPath}/assets/js/gsap.min.js"></script>
<script>
    var yetiTL, chatterTL;
    var furLightColor = "#FFF";
    var furDarkColor = "#67b1e0";
    var skinLightColor = "#ddf1fa";
    var skinDarkColor = "#88c9f2";
    var lettersSideLight = "#3A7199";
    var lettersSideDark = "#051d2c";
    var lettersFrontLight = "#67B1E0";
    var lettersFrontDark = "#051d2c";
    var lettersStrokeLight = "#265D85";
    var lettersStrokeDark = "#031219";

    var mouthShape1 = "M149 115.7c-4.6 3.7-6.6 9.8-5 15.6.1.5.3 1.1.5 1.6.6 1.5 2.4 2.3 3.9 1.7l11.2-4.4 11.2-4.4c1.5-.6 2.3-2.4 1.7-3.9-.2-.5-.4-1-.7-1.5-2.8-5.2-8.4-8.3-14.1-7.9-3.7.2-5.9 1.1-8.7 3.2z";
    var mouthShape2 = "M161.2 118.9c0 2.2-1.8 4-4 4s-4-1.8-4-4c0-1 .4-2 1.1-2.7.7-.8 1.8-1.3 2.9-1.3 2.2 0 4 1.7 4 4z";
    var mouthShape3 = "M150.2 118.3c-4.6 3.7-7.5 6.4-6.3 12.3.1.5.1.6.3 1.1.6 1.5 2.4 2.3 3.9 1.7 0 0 7.9-4.3 10.7-5.5s11.6-3.3 11.6-3.3c1.5-.6 2.3-2.4 1.7-3.9-.2-.5-.2-.6-.4-1.1-2.8-5.2-7.1-4.9-12.9-4.6-3.7.4-6.3 1.5-8.6 3.3z";
    var mouthShape4 = "M149.2 116.7c-4.6 3.7-6.7 8.8-5.2 14.6.1.3.1.5.2.8.6 1.5 2.4 2.3 3.9 1.7l11.2-4.4 11.2-4.4c1.5-.6 2.3-2.4 1.7-3.9-.1-.3-.2-.5-.4-.7-2.8-5.2-8.2-7.2-14-6.9-3.6.2-5.9 1.1-8.6 3.2";

    chatterTL = new gsap.timeline({ paused: true, repeat: -1, yoyo: true });
    chatterTL
        .to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.1, { morphSVG: mouthShape4 }, "0")
        .to('#chin', 0.1, { y: 1.5 }, "0");

    yetiTL = new gsap.timeline({ paused: true, repeat: -1, repeatDelay: 0, delay: 0 });
    yetiTL
        .add(function () {
            chatterTL.play();
        }, "0")
        ...
        .add(function () {
            chatterTL.pause();
            gsap.to(['#mouthBG', '#mouthPath', '#mouthOutline'], 0.1, { morphSVG: mouthShape1 }, "0");
        }, "3.2")
        ...
        goDark(); // Set the initial dark state
        yetiTL.play(); // Start playing the 'yetiTL' timeline
    </script>