                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label class="control-label" style="">Activity :</label>
                                                <select class="col-md-3 form-control form-select" id="stageName" onchange="getTableTabDetails(this.value)" name="className">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsiv">
                                        <table class="table table-bordered table-hover table-striped" id="sct">
                                            <thead class="bagGroundColorRvr" style="color: #fff;">
                                                <tr>
                                                    <th style="text-align:center;width: 60px;">Sl. No</th>
                                                    <th>Role</th>
                                                    <th>Tab</th>
                                                    <th>Stage Forwarded Rule</th>
                                                    <th style="width: 60px;"><button type="button" class="btn btn-sm btn-success" onclick="addRow()"><i class="fa-solid fa-plus"></i></button></th>
                                                </tr>
                                            </thead>
                                            <tbody id="sctBody">
                                                <c:choose>
                                                    <c:when test="${roleMapLst.size() > 0}">
                                                        <c:forEach items="${roleMapLst}" var="tab" varStatus="count">
                                                            <tr id="row${count.index}" class="${count.count ne roleMapLst.size() ? 'disabled-field' : ''}">
                                                                <td style="text-align:center;">${count.count}<input type="hidden" value="${count.count}" name="tabDto[0].displayOrder"></td>
                                                                <td>
                                                                    <select class="col-md-3 form-control form-select" id="roleId${count.index}" name="tabDto[${count.index}].roleId" >
                                                                        <option value="">--Select--</option>
                                                                ...
                                                                <td>
                                                                    <select class="col-md-3 form-control form-select" id="statusId${count.index}" name="tabDto[${count.index}].statusId" >
                                                                        <option value="">--Select--</option>
                                                                ...
                                                                <td>
                                                                    <select class="col-md-3 form-control form-select" id="stageId${count.index}" name="tabDto[${count.index}].stageId" >
                                                                        <option value="">--Select--</option>
                                                                        <c:forEach items="${stageForwardedRuleList}" var="stageRule">
                                                                            <option value="${stageRule.forwardedId}" ${stageRule.forwardedId eq tab.stageForwardedRule.forwardedId ? 'selected' : ''}>${stageRule.fwdRuleCode} (${stageRule.actionType.actionCode})</option>
                                                                        </c:forEach>
                                                                    </select>
                                                                </td>
                                                                <td>
                                                                    <button type="button" class="btn btn-sm btn-danger" onclick="removeRow(${count.index})"><i class="fa fa-trash"></i></button>
                                                                </td>
                                                            </tr>
                                                    ...
                                                    <c:otherwise>
                                                        <tr id="row0" style="vertical-align: middle;" >
                                                            <td style="text-align:center;">1<input type="hidden" value="1" name="tabDto[0].displayOrder"></td>
                                                            <td>
                                                                <select class="col-md-3 form-control form-select" id="roleId0" name="tabDto[0].roleId" >
                                                                    <option value="">--Select--</option>
                                                                    <c:forEach items="${roleList}" var="role">
                                                            ...
                                                            <td>
                                                                <select class="col-md-3 form-control form-select" id="statusId0" name="tabDto[0].statusId" >
                                                                    <option value="">--Select--</option>
                                                                    <c:forEach items="${viewStatusList}" var="status">
                                                            ...
                                                            <td>
                                                                <select class="col-md-3 form-control form-select" id="stageId0" name="tabDto[0].stageId" >
                                                                    <option value="">--Select--</option>
                                                                    <c:forEach items="${stageForwardedRuleList}" var="stageRule">
                                                                        <option value="${stageRule.forwardedId}">${stageRule.fwdRuleCode} (${stageRule.actionType.actionCode})</option>
                                                                    </c:forEach>
                                                                </select>
                                                            </td>
                                                            <td>
