...
public class CommonUtils {
	...
	public static boolean isFileValid(MultipartFile file, RedirectAttributes message) throws IOException {
		...
		if (attachment.equalsIgnoreCase("pdf")) {
			...
			if (!fileSuspicious) {
				message.addFlashAttribute(ApplicationConstants.ERROR_MSG,
						"One or more suspicious files were found. Unable to save data.");
				return false;
			}
		} else if (!(attachment.equalsIgnoreCase("png") || attachment.equalsIgnoreCase("jpg")
				|| attachment.equalsIgnoreCase("jpeg"))) {
